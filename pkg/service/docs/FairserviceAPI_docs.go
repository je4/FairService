...
const docTemplateFairserviceAPI = `{
...
// SwaggerInfoFairserviceAPI holds exported Swagger Info so clients can modify it
var SwaggerInfoFairserviceAPI = &swag.Spec{
	Version:          "1.0",
	Host:             "",
	BasePath:         "",
	Schemes:          []string{},
	...
	InfoInstanceName: "FairserviceAPI",
	SwaggerTemplate:  docTemplateFairserviceAPI,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfoFairserviceAPI.InstanceName(), SwaggerInfoFairserviceAPI)
}
