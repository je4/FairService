                ...
                <div class="container">
                    <div class="navbar navbar-default" role="navigation">
                        <div class="navbar-header">
                            <a class="navbar-brand" href="#">FAIRService OAI-PMH Data Provider</a>
                        </div>
        ...
        <xsl:if test="text() != ''">
            <div class="text-center">
                <a class="btn btn-primary">
                    <xsl:attribute name="href">
                        <xsl:value-of select="concat(/oai:OAI-PMH/oai:request/text(), '?verb=',/oai:OAI-PMH/oai:request/@verb,'&amp;resumptionToken=', text(), '&amp;metadataPrefix=', /oai:OAI-PMH/oai:request/@metadataPrefix)"></xsl:value-of>
                    </xsl:attribute>
                    Show More
                </a>
            </div>
